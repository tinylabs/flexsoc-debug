...
void mem_byte_rw (Target *target)
{
  ...
  assert (target->WriteAP (0, 0xC, 0x11) == ADIv5_OK);
  assert (target->WriteAP (0, 4, 0x20000001) == ADIv5_OK);
  assert (target->WriteAP (0, 0xC, 0x2200) == ADIv5_OK);
  assert (target->WriteAP (0, 4, 0x20000002) == ADIv5_OK);
  assert (target->WriteAP (0, 0xC, 0x330000) == ADIv5_OK);
  assert (target->WriteAP (0, 4, 0x20000003) == ADIv5_OK);
  assert (target->WriteAP (0, 0xC, 0x44000000) == ADIv5_OK);
...
void mem_hwrd_rw (Target *target)
{
  ...
  assert (target->WriteAP (0, 4, 0x20000000) == ADIv5_OK);
  assert (target->WriteAP (0, 0xC, 0x1111) == ADIv5_OK);
  assert (target->WriteAP (0, 4, 0x20000002) == ADIv5_OK);
  assert (target->WriteAP (0, 0xC, 0x22220000) == ADIv5_OK);
  assert (target->WriteAP (0, 4, 0x20000004) == ADIv5_OK);
  assert (target->WriteAP (0, 0xC, 0x3333) == ADIv5_OK);
  assert (target->WriteAP (0, 4, 0x20000006) == ADIv5_OK);
  assert (target->WriteAP (0, 0xC, 0x44440000) == ADIv5_OK);
...
void mem_word_rw (Target *target)
{
  ...
  assert (target->WriteAP (0, 0x10, 0x11223344) == ADIv5_OK);
  assert (target->WriteAP (0, 0x14, 0x55667788) == ADIv5_OK);
  assert (target->WriteAP (0, 0x18, 0x9900AABB) == ADIv5_OK);
  assert (target->WriteAP (0, 0x1C, 0xCCDDEEFF) == ADIv5_OK);

  // Read back words
  assert (target->ReadAP (0, 0x10, &val) == ADIv5_OK);
  assert (val == 0x11223344);
  assert (target->ReadAP (0, 0x14, &val) == ADIv5_OK);
  assert (val == 0x55667788);
  assert (target->ReadAP (0, 0x18, &val) == ADIv5_OK);
  assert (val == 0x9900AABB);
  assert (target->ReadAP (0, 0x1C, &val) == ADIv5_OK);
...
void mem_word_autoinc (Target *target)
{
  ...
  assert (target->WriteAP (0, 0, 0xA3000012) == ADIv5_OK);
  ...
  assert (target->WriteAP (0, 0xC, 0x55667788) == ADIv5_OK);
  assert (target->WriteAP (0, 0xC, 0x9900AABB) == ADIv5_OK);
  assert (target->WriteAP (0, 0xC, 0xCCDDEEFF) == ADIv5_OK);
...
int main (int argc, char **argv)
{
  ...
  assert (target->WriteAP (0, 0, 0xA3000000) == ADIv5_OK);
